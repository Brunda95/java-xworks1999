class AmazonPrime{
static String movies[]={"shersha","junglebook"};
static String series[]={"mirzapur","familyman"};
...
String series=getMovies(series);
...
public static String getMovies(String[] series){
System.out.println("the web series");
